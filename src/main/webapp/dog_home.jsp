...
<body>
    ...
    <div class="main-content">
        <div class="top-bar">
            <h2>🐶 Gerenciar Cães</h2>
            <a href="index.jsp" class="back-btn">← Voltar ao Dashboard</a>
        </div>

        <div class="actions-grid">
            <a href="dog_register.jsp" class="action-card">
                <div class="action-icon">➕</div>
                <h3>Cadastrar Cão</h3>
                <p>Adicione novos pets ao sistema</p>
            </a>

            <a href="dog_list.jsp" class="action-card">
                <div class="action-icon">📋</div>
                <h3>Listar Cães</h3>
                <p>Visualize todos os cães por cliente</p>
            </a>

            <a href="dog_provision_list.jsp" class="action-card">
                <div class="action-icon">📊</div>
                <h3>Histórico de Serviços</h3>
                <p>Consulte serviços prestados por cão</p>
            </a>
        </div>
    </div>
</body>
